...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg  footer-fixed navbar-fixed">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">New Crime</h1>
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Register a new crime</h3>
                                </div>
                                ...
                                <form action="/crime" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Select Crime</label>
                                                    <select name="offence_id" id="crime" class="form-control" required>
                                                        <option value="" selected disabled="disabled">-- Select the crime --</option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Crime Code</label>
                                                    <input type="text" id="crime_code" disabled name="crime_code" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Crime Points</label>
                                                    <input type="text" id="crime_points" disabled name="crime_points" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Crime Penalty (#)</label>
                                                    <input type="text" id="crime_penalty" disabled name="crime_penalty" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle Chasis</label>
                                                    <input type="number" name="vehicle_chasis" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="vehicle_insurance" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Location</label>
                                                    <input type="text" name="crime_place" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Route Plyed</label>
                                                    <input type="text" name="crime_route" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Officer's Name</label>
                                                    <input type="text" name="assaulted_official" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Officer's Rank</label>
                                                    <input type="text" name="assaulted_official_rank" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Officer's Base</label>
                                                    <input type="text" name="assaulted_official_base" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Officer's Phone</label>
                                                    <input type="text" name="assaulted_official_phone" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle Owner's Address</label>
                                                    <input type="text" name="owners_address" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle Owner's Date of Birth</label>
                                                    <input type="text" name="vehicle_owners_date_of_birth" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle Owner's Phone</label>
                                                    <input type="text" name="owners_phone" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle State of Purchase</label>
                                                    <input type="text" name="vehicle_state_of_purchase" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Crime Picture</label>
                                                    <input type="file" accept="image/*" id="crime_picture" name="crime_picture" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Vehicle Owner's Passport</label>
                                                    <input type="file" accept="image/*" id="passport" name="offenders_passport" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        var crimestext = "{{ json_encode($crimes) }}";
        crimestext = crimestext.replace(/&quot;/g, '"');
        var crimes = JSON.parse(crimestext) || [];
        document.body.onload = function () {
            var crime = document.getElementById('crime');

            function setDisabledValues(e) {
                e.preventDefault();
                var selectedCrime = crime.options[crime.selectedIndex].value;
                selectedCrime = crimes.find(function (value, i) {
                    return value.id == selectedCrime;
                });
                document.getElementById('crime_code').value = selectedCrime.code;
                document.getElementById('crime_points').value = selectedCrime.point;
                document.getElementById('crime_penalty').value = selectedCrime.penalty;
            }
            crime.addEventListener('change', setDisabledValues);
        }
    </script>
