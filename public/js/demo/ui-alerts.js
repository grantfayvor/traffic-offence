...
$(document).ready(function() {
    ...
    btn_alert.on("click", function(e) {
        e.preventDefault();
        $.niftyNoty({
            type: alert_style, //primary
            container: alert_type, //floating
            html: alert_content[alert_layout].type, //'<strong>Well done!</strong> You successfully read this important alert message.'
            closeBtn: closebtn_alert, //true
            floating: {
                position: "top-right",
                animationIn: select_animin.val(), //bounceInDown
                animationOut: select_animout.val() //fadeOut
            },
            focus: true,
            timer: input_sticky.prop("checked") ? 2500 : 0 // true ? 2500 : 0
        });
    });
